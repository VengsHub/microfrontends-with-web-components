...
import { SearchLink } from '@kpark/zpa-components/lib/shared/models/search-link.model';
...
export class DataService {
  ...
  public readonly patientList$: Observable<SearchLink[]> = this.routeDataService.queryParams$.pipe(
